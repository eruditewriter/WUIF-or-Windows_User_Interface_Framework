...
namespace WUIF {
	...
	public:
		...
		//void(D3D11Resources::*createresources)(D3D11Resources*);        
		...
		DXResources *DXres;
	private:
		static void CreateRenderTargets(D3D11Resources*);
	};
	...
	public:
		...
		static bool                     usingD3D12;
		static const D3D_FEATURE_LEVEL  minDXFL;
		...
		static       IDeviceNotify     *deviceNotify; //a mechanism for allowing user code to handle DirectX device loss

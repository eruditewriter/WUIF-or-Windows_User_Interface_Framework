...
D3D12Resources::D3D12Resources(DXResources *dxres) :
	DXres(dxres)
{
...
void D3D12Resources::CreateStaticResources()
{
	...
	if (lib)
	{
		...
		ThrowIfFailed(created3d12device(DXGIResources::dxgiAdapter.Get(), DXResources::minDXFL, IID_PPV_ARGS(&d3d12Device)));
	}
	else
	{
